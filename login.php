<?php
	...
	if(isset($_POST["login"])){
		...
		if(empty($pword)){
			...
			$query = "select uname, pw from user where uname=".$user." and pw like '".$pw."'";
...
<html>
	...
	<body>
		<form name="loginform" action="login.php" method="POST" onSubmit="return checkit()">
			<input type="text" name="uname" placeholder="Username" id="uname" value="<?php if(!empty($user)) echo $user; ?>"/><br/>
